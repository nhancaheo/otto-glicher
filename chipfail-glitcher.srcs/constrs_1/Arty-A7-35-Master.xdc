...
## Pmod Header JC
set_property -dict { PACKAGE_PIN U12   IOSTANDARD LVCMOS33 } [get_ports { gpio[0] }]; #IO_L20P_T3_A08_D24_14 Sch=jc_p[1]
...
set_property -dict { PACKAGE_PIN V11   IOSTANDARD LVCMOS33 } [get_ports { gpio[3] }]; #IO_L21N_T3_DQS_A06_D22_14 Sch=jc_n[2]
...
set_property -dict { PACKAGE_PIN U13   IOSTANDARD LVCMOS33 } [get_ports { gpio[7] }]; #IO_L23N_T3_A02_D18_14 Sch=jc_n[4]

## Pmod Header JD
set_property -dict { PACKAGE_PIN D4    IOSTANDARD LVCMOS33 } [get_ports { trigger_in }]; #IO_L11N_T1_SRCC_35 Sch=jd[1]
